/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    Shree Bala Ji Builders & Contractor lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for Shree Bala Ji Builders & Contractor (blue room, brand phrase).
*/
...
const PHRASE = 'Shree Bala Ji Builders & Contractor · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Shree Bala Ji Builders & Contractor</span><span>REALTY</span></div>
